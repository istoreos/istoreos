...
define Package/iwlwifi-firmware-ax211/install
	$(INSTALL_DIR) $(1)/lib/firmware
	$(INSTALL_DATA) $(PKG_BUILD_DIR)/intel/iwlwifi/iwlwifi-so-a0-gf-a0-89.ucode $(1)/lib/firmware
	$(INSTALL_DATA) $(PKG_BUILD_DIR)/intel/iwlwifi/iwlwifi-so-a0-gf-a0.pnvm $(1)/lib/firmware
endef
...
define Package/i915-firmware-dmc/install
	...
	$(INSTALL_DATA) $(PKG_BUILD_DIR)/i915/bmg_dmc.bin $(1)/lib/firmware/i915/
	...
	$(INSTALL_DATA) $(PKG_BUILD_DIR)/i915/xe2lpd_dmc.bin $(1)/lib/firmware/i915/
endef
