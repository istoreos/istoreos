...
define Device/mofinetwork_mofi5500-5gxelte
  ...
  DEVICE_PACKAGES := kmod-usb3 kmod-mmc-mtk kmod-mt7615-firmware \
	kmod-usb-net-qmi-wwan kmod-usb-net-cdc-mbim kmob-mhi-net \
	kmod-qrtr-mhi kmod-mhi-pci-generic kmod-mhi-wwan-mbim \
	kmod-mhi-wwan-ctrl kmod-usb-net usb-modeswitch kmod-usb-serial \
	kmod-usb-serial-option kmod-usb-serial-wwan usbutils pciutils minicom \
	fibocom-dial kmod-pcie_mhi
